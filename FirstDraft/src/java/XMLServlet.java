...
pw.println("{");
pw.println("var xmhttp;");
//pw.println("if (window.XMLHttpRequest)");
//pw.println("{");
pw.println("xmhttp=new XMLHttpRequest();");
//pw.println("}");
//pw.println("else");
//pw.println("{");
//pw.println("xmhttp=new ActiveXObject('Microsoft.XMLHTTP')");
//pw.println("}");
pw.println("xmhttp.open('GET',filename,false);");
pw.println("xmhttp.send();");
pw.println("return xmhttp.responseXML;}");
pw.println("</script>");
pw.println("");
pw.println("");
pw.println("");
...
FileInputStream inss = new FileInputStream(fName);
      ...
      while ((strLine2 = cr.readLine()) != null) {
        ...
        cnt++;}
      pw.println("<form method='POST' onsubmit='myFunction()' action='XMLServler2' id='yoho'><table hidden id='mytable' border='1'  >");
      int xx=0;
...
pw.println("<input type='hidden' id ='kuj' name='kuj' value='6'>");
pw.println("<input type='hidden' id ='asdf' name='fil' value='"+xmld+"'>");
pw.println("<input type='hidden' id ='asdf' name='last_name' value='"+columns+"'>");
pw.println("<input type='hidden' id ='asdf' name='first_name' value='"+fName+"'>");
pw.println("<input type='hidden' id ='fil' name='fil' value='"+xmld+"'>");


pw.println("<input type='submit' value='Continue' name='ede'  /></form>");
pw.println("<script type='text/javascript'>");
pw.println("function myFunction()");
pw.println("{");
pw.println("document.getElementById('kuj').value=9");
//pw.println("var xmld=document.getElementById('fil').value");

//pw.println("xmlDoc=loadXMLDoc('"+xmld+"');");
//pw.println("alert(xmldoc)");
//pw.println("if (window.XMLHttpRequest)");
//pw.println("{");
pw.println("xmlhttp=new XMLHttpRequest();");
//pw.println("}");

pw.println("xmlhttp.open('GET','file:///C:/Users/onxsoh1/Desktop/domain.xml',false)");
//pw.println("setRequestHeader('Content-Type', 'text/xml'");
//pw.println("xmlhttp.send('');");
pw.println("alert('f')");
//pw.println("xmlhttp.send();");
//pw.println("return xmlhttp.responseXML;");
pw.println("xmlDoc=xmlhttp.responseXML;");
pw.println("alert('flag')");
pw.println("alert(xmlDoc)");
pw.println("alert('flag for the checking of validation')");


pw.println("var x=xmlDoc.getElementsByTagName('<j2ee-application>')");
pw.println("alert('hi');");
pw.println("var cnt=0;");
pw.println("alert(cnt);");
...
pw.println("cnt++;}");
pw.println("}");
pw.println("docment.getElementById('kuj').value=10");
pw.println("");
