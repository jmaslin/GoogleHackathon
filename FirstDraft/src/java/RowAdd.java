...
public class RowAdd extends HttpServlet {

    public void doPost(HttpServletRequest req, HttpServletResponse res)
            throws IOException, ServletException {
        res.setContentType("text/html;charset=UTF-8");
        PrintWriter pw = res.getWriter();
        int rows = Integer.parseInt(req.getParameter("something"));
        int columns = Integer.parseInt(req.getParameter("last_name"));
        ServletContext cntxt = getServletContext();
        pw.println("<html>");
        pw.println("<head>");

        pw.println("<script type='text/javascript'>");//This is the table editing script.
        ...
        if (ins == null) {//Error message if filename is not found.
            ...
            //This part adds additional rows to the file based off of the number of rows posted in index.html.
            ...
            pw.println("<input type='hidden' id ='asdf' name='asdf' value='" + rows + "'>");
