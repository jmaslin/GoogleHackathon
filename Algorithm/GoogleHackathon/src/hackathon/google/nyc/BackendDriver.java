...
public class BackendDriver {
	 ...
	 * @throws IOException 
	 */
	public ComparableRequestQuery newQuery(String type, String keyword,Point2D.Double coord, String name,String number) throws InvalidKeyException, IOException{
		ComparableRequestQuery rq = new ComparableRequestQuery(type,keyword,coord,name,number);
